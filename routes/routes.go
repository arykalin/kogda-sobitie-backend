...
func Routes() *mux.Router {
	...
	//router.HandleFunc("/event/{id}", middlewares.IsAuthorized(event_controller.DeleteEvent)).Methods("DELETE")
	//router.HandleFunc("/event/{id}", middlewares.IsAuthorized(event_controller.UpdateEvent)).Methods("PUT")
